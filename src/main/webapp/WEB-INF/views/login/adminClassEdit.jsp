...
<script type="text/javascript" src="../script/jquery_adminClassEdit.js"></script>
<body>
			...
			<div class="container1">
				<table>
					<tr>
						...
						<td><input type="text" id="div강의번호" class="form-control" name="class_no" value="${c.class_no }" readonly="readonly"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><select id="div이수구분" class="form-control" name="class_type">
							<option id="class_type" selected disable hidden value="${c.class_type }"></option>
					...
					<tr>
						...
						<td><select id="div대상학년" class="form-control" name="class_level">
							<option selected disable hidden value="${c.class_level }">${c.class_level }학년</option>
					...
					<!-- professor 의 pro_type 은 college_no 와 연동되어있지 않다. 그러므로 pro_type 은 String ! -->
						...
						<td><select class="form-control" name="pro_type" id="pro_type">
							<option id="changeProType" selected disable hidden value="${c.college_no }"></option>
					...
					<!-- <td><input type="number" id="div교수번호" class="form-control" name="pro_no"></td> -->
						<td><select id="proList" name="pro_no">
							<option selected disable hidden value="${c.pro_no }">${c.pro_name }</option>
					<!-- ajax 으로 추가 -->
						</select></td>
					</tr>
					<tr>
						...
						<td><select id="div제한인원" class="form-control" name="class_max">
							<option selected disable hidden value="${c.class_max }">${c.class_max }</option>
